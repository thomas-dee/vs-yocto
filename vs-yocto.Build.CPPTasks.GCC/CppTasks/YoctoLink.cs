...
{
    public class YoctoLink : TrackedVCToolTask
    {
        ...
        public virtual string[] SharedLibraryRuntimeSearchPath
        {
            get
            {
                if (this.IsPropertySet("SharedLibraryRuntimeSearchPath"))
                    return this.ActiveToolSwitches["SharedLibraryRuntimeSearchPath"].StringList;
                return (string[])null;
            }
            set
            {
                this.ActiveToolSwitches.Remove("SharedLibraryRuntimeSearchPath");
                ToolSwitch switchToAdd = new ToolSwitch(ToolSwitchType.StringPathArray);
                switchToAdd.DisplayName = "Shared Library Runtime Search Path";
                switchToAdd.Description = "Allows the user to populate the shared library runtime search path.";
                switchToAdd.ArgumentRelationList = new ArrayList();
                switchToAdd.SwitchValue = "-Wl,-rpath=";
                switchToAdd.Name = "SharedLibraryRuntimeSearchPath";
                switchToAdd.StringList = value;
                this.ActiveToolSwitches.Add("SharedLibraryRuntimeSearchPath", switchToAdd);
                this.AddActiveSwitchToolValue(switchToAdd);
            }
        }
        ...
        public bool OpenMPSupport
        {
            get
            {
                if (this.IsPropertySet("OpenMPSupport"))
                    return this.ActiveToolSwitches["OpenMPSupport"].BooleanValue;
                return false;
            }
            set
            {
                this.ActiveToolSwitches.Remove("OpenMPSupport");
                ToolSwitch switchToAdd = new ToolSwitch(ToolSwitchType.Boolean);
                switchToAdd.DisplayName = "OpenMPSupport";
                switchToAdd.Description = "Specifies that OpenMP support is to be used.";
                switchToAdd.ArgumentRelationList = new ArrayList();
                switchToAdd.SwitchValue = "-fopenmp";
                switchToAdd.Name = "OpenMPSupport";
                switchToAdd.BooleanValue = value;
                this.ActiveToolSwitches.Add("OpenMPSupport", switchToAdd);
                this.AddActiveSwitchToolValue(switchToAdd);
            }
        }
        ...
        public bool GNUMode { get; set; } = true;
          ...
          : base(new ResourceManager("Microsoft.Build.CPPTasks.Strings", Assembly.GetExecutingAssembly()))
        {
            ...
            this.switchOrderList.Add((object)"OpenMPSupport");
            ...
            this.switchOrderList.Add((object)"SharedLibraryRuntimeSearchPath");
